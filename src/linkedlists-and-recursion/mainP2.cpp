...
void Message_X_MessageQueue() {
  ...
  // Feel free to comment out the Game reference in the main, and add tests
  // for individual classes here Before you put everything together
...
static void More_Interesting_Map_For_Lighting() {
  cout << " ------------- More_Interesting_Map_For_Lighting ------------- "
       << endl;
  const int w = 17;
  const int h = 6;
  string array = "#########^#######"
