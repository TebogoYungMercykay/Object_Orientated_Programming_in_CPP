...
Matrix::Matrix(int in_rows, int in_columns) {
  if (in_rows < 1 || in_columns < 1) {
    ...
    for (; k_iterator < this->rows; k_iterator++) {
      ...
      int t_iterator = 0;
      for (; t_iterator < this->columns; t_iterator++) {
...
Matrix::~Matrix() {
  ...
  for (; k_iterator < this->rows; k_iterator++) {
    int t_iterator = 0;
    for (; t_iterator < this->rows; t_iterator++) {
...
void Matrix::resizeRows(int num_rows) {
  if (num_rows < 1) {
    ...
    for (; k_iterator < this->rows; k_iterator++) {
      ...
      int t_iterator = 0;
      for (; t_iterator < this->columns; t_iterator++) {
        this->matrix[k_iterator][t_iterator] =
            new int(arr[k_iterator][t_iterator]);
      }
    }
    k_iterator = 0;
