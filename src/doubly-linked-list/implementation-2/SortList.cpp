...
template <class T> SortList<T>::SortList(bool val) {
  this->ascending = val;
  this->tail = this->head = NULL;
}
template <class T> void SortList<T>::add(SortNode<T> *val) {
  if (this->tail != NULL) {
    val->prev = this->tail;
    this->tail->next = val;
    this->tail = val;
...
template <class T> void SortList<T>::setAsc(bool val) {
  this->ascending = val;
  this->sort();
}
template <class T> std::string SortList<T>::debug() {
...
template <class T> std::string SortList<T>::print() {
  std::string temp_string("");
...
template <class T> SortNode<T> *SortList<T>::getHead() { return this->head; }
template <class T> SortNode<T> *SortList<T>::remove(T val) {
