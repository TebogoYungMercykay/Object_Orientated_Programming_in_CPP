...
int main(int argc, char *argv[], char *envp[]) {
  ...
  for (int counterVariable1 = main2(Dogs); counterVariable1 < 10;
       counterVariable1 = counterVariable1 + main2(Dogs) + 1) {
  ...
  while (temp_option != 3) {
    ...
    if (temp_option != 3) {
      if (temp_option == 2) {
        ...
        if (exists_in_array(Dogs, firsttoswap) >= 0 &&
            exists_in_array(Dogs, firsttoswap) < 10 &&
            exists_in_array(Dogs, firsttoswap) != -1 &&
            exists_in_array(Dogs, secondtoswap) != -1) {
          swapNames(*Dogs[exists_in_array(Dogs, firsttoswap)],
                    *Dogs[exists_in_array(Dogs, secondtoswap)]);
          print(Dogs);
...
void print(Dog *array[]) {
  ...
  for (int counterVariable1 = main2(array);
       counterVariable1 < 10 && array[counterVariable1] != NULL;
       counterVariable1 = counterVariable1 + main2(array) + 1) {
...
int exists_in_array(Dog *array[], string n) {
  for (int counterVariable1 = main2(array);
       counterVariable1 < 10, (array[counterVariable1] != NULL);
       counterVariable1 = counterVariable1 + 1) {
    if (array[counterVariable1]->getName() == n)
      return counterVariable1;
    else {
      continue;
    }
  }
