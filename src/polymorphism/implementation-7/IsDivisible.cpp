...
IsDivisible::~IsDivisible() { IsDivisible::numAliveObjects--; }

bool IsDivisible::evaluate(int val) {
  if (ValueDependantTester::value != 0 &&
      val % ValueDependantTester::value == 0) {
    return true;
  }
  return false;
}

int IsDivisible::getNumAliveObjects() { return IsDivisible::numAliveObjects; }
