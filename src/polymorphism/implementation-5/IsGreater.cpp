 ...
 * IsGreater objects. This variable should be initially initialized to a value
 * of 0.
 */
 ...
 *   This function should also initialize the inherited value member with the
 * passed in member
 */
...
/*
 *   This function should determine if the passed in value  is strictly greater
 * than the inherited value member. If it is, then the function should return
 * true else false.
 */
bool IsGreater::evaluate(int val) { return (val > this->value); }
/*
 *   This function should return a new IsGreater pointer initialized with the
 * inherited variable member.
 */
NumberTester *IsGreater::clone() { return new IsGreater(this->value); }
/*
 *   This is a static function.
 *   This function should return the static numAliveObjects member of IsGreater
 * class.
 */
