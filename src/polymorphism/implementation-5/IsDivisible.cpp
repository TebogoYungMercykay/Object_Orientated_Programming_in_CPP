 ...
 * IsDivisible objects. This variable should be initially initialized to a value
 * of 0.
 */
 ...
 */
IsDivisible::~IsDivisible() { this->numAliveObjects--; }

/*
 *   This function should determine if the passed in value is divisible with the
 * inherited value member. If it is, then the function should return true else
 * false.
 */
bool IsDivisible::evaluate(int val) { return (val % this->value == 0); }
/*
 *   This function should return a new IsDivisible pointer initialized with the
 * inherited variable member.
 */
NumberTester *IsDivisible::clone() { return new IsDivisible(this->value); }
/*
