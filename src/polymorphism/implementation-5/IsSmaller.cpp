 ...
 * IsSmaller objects. This variable should be initially initialized to a value
 * of 0.
 */
...
/*
 *   This function should determine if the passed in value  is strictly smaller
...
/*
 *   This function should return a new IsSmaller pointer initialized with the
 * inherited variable member.
 */
NumberTester *IsSmaller::clone() { return new IsSmaller(this->value); }
/*
 *   This is a static function.
 *   This function should return the static numAliveObjects member of IsSmaller
 * class.
 */
