...
private:
   ...
   * IsGreater objects. This variable should be initially initialized to a
   * value of 0.
   */
...
public:
   ...
   * greater than the inherited value member. If it is, then the function
   * should return true else false.
   */
  bool evaluate(int val);
  /*
   *   This function should return a new IsGreater pointer initialized with
