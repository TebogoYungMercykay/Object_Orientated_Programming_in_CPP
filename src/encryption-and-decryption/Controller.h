...
private:
  ...
  int numBabushkas;
  ReturnStruct expandArray(unsigned char *array, int currentSize,
                           const unsigned char *id, int idSize);
  ReturnStruct reduceArray(unsigned char *array, int currentSize,
                           const unsigned char *expectedId, int idSize);
