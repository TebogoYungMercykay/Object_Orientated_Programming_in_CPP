...
template <class E> NotFoundEx<E>::NotFoundEx(E *miss) {
...
template <class E> UndervaluedEx<E>::UndervaluedEx(E *val, double sum) {
...
template <class E> double UndervaluedEx<E>::getSum() const {
