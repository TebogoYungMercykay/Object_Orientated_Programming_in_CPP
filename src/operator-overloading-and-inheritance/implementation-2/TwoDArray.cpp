...
TwoDArray::operator int() { return this->getBaseSize(); }
TwoDArray::operator int *() { return this->getSizes(); }
TwoDArray::operator int **() { return this->getArray(); }
...
int *TwoDArray::operator[](int index) { return 0; }