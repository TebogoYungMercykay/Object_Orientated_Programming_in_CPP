...
void benchMark(int numGenerations, int popSize, int selectionSize, int numGenes,
               long seed, bool generationResults, bool timeResults);
void benchMark_GA_CLASS(int numGenerations, int popSize, int selectionSize,
                        int numGenes, long seed, bool generationResults,
                        bool timeResults);
...
void benchMark_GA_CLASS(int numGenerations, int popSize, int selectionSize,
  ...
  std::cout << "Your Avg avg: " << avg(results, 0, numGenerations) << " -> "
            << "Expected Avg avg: 0.692" << endl;
  std::cout << "Your Avg std: " << avg(results, 1, numGenerations) << " -> "
            << "Expected Avg std: 0.169021" << endl;
  std::cout << "Your Avg var: " << avg(results, 2, numGenerations) << " -> "
            << "Expected Avg var: 0.41" << endl;
  std::cout << "------------------------------------------------" << std::endl;
  ...
  std::cout << "------------------------------------------------" << std::endl;
  if (timeResults)
    std::cout << "Execution time: " << difftime(endTime, startTime) / 1000
              << "ms" << endl;
  for (int i = 0; i < numGenerations; i++) {
    delete[] results[i];
  }
  ...
  std::cout << "---------------------------------------------------------------"
               "----------------"
            << std::endl;
  std::cout << "------------------------------- END OF GA CLASS "
               "-------------------------------"
            << std::endl;
  std::cout << "------- THIS MAIN DOESN'T NECESARILY GUARANTEE FULL MARKS "
               "BUT... (*_*) --------"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
...
void CHROMOSOME_CLASS() {
  ...
  FitnessFunction *fitnessFunction = new FitnessFunction();
  std::cout << "--------------------------- TESTING CHROMOSOME CLASS "
               "--------------------------"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
  ...
  std::cout << "There Are: " << myC1->getNumGenes() << " -> 10 genes"
            << std::endl;
  for (int i = 0; i < 10; i++) {
  ...
  std::cout << "------------------------------------------------" << std::endl;
  std::cout << "0.6 -> "
            << myC3->fitness(fitnessFunction, myC2, myC2->getNumGenes())
            << endl;
  ...
  std::cout << "---------------------------------------------------------------"
               "----------------"
            << std::endl;
  std::cout << "-------------------------- END OF CHROMOSOME CLASS "
               "----------------------------"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
            << std::endl;
  std::cout << "--if You See This, Your Chromosome,RandomGenerator and "
               "FitnessFunction Work!!--"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
            << std::endl;
...
void GA_CLASS() {
  std::cout << "-------------------------- NOW TESTING THE GA CLASS "
               "---------------------------"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
  ...
  GA *gd = new GA(ga);
  std::cout << "- Using: className *objName1 = new className(objName2)--"
            << std::endl;
...
void GA_GLASS_EXTENDED() {
  std::cout << "---- NOW TESTING: run(FitnessFunction* fitnessFunction,int "
               "numGenerations) ----"
            << std::endl;
  std::cout << "------------------------ Mutate AND crossOver functions "
               "-----------------------"
            << std::endl;
  std::cout << "---------------------------------------------------------------"
               "----------------"
