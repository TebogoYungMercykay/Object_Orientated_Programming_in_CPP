...
template<typename T>
SortList<T>::SortList(bool mValue): ascending(mValue){
    SortList<T>::tail = NULL, head = NULL;
}
template<typename T>
void SortList<T>::add(SortNode<T>* mValue){
    if(SortList<T>::tail){
...
template<typename T>
void SortList<T>::setAsc(bool mValue){
...
template<typename T>
SortNode<T>* SortList<T>::remove(T mValue){
