    ...
    do
    {
        ...
        if(temp!=option_Exit)
        {
            if(temp == option_Exit-2)
            {
                ...
                std::cout<<str.substr(0,str.length()-(option_Exit-1))<<std::endl;
            }
            else if(temp == option_Exit-1)
            {
                ...
                else if(containsDog(arrayDogs,firs)==-1 || containsDog(arrayDogs,secon)==-1)
                {
                    std::cout<<"No dog found"<<std::endl;
                }
                else
                {
                    swapNames(*arrayDogs[containsDog(arrayDogs,firs)],*arrayDogs[containsDog(arrayDogs,secon)]);
