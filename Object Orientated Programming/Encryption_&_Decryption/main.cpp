...
int main(){
    ...
    string plainText = "Thisismyphenomenalstring"; // Note this can have any char in the range 32 to 126 inclusive.
    ...
    try{ 
        ...
        ReturnStruct plainTextReturn  = c->decrypt(cipherReturn.returnArray, cipherReturn.arraySize);
        delete [] cipherReturn.returnArray;
        delete [] plainTextReturn.returnArray; //free memory

        cout << endl << "Example Exception:" <<endl; 
        arr[0] = '!'; // This character induces an underflow exception in this scenario
